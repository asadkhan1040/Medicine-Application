...
import { listPatientReducer, patientDeleteReducer, patientStatusReducer } from "../../reduxData/PatientSlice"
                    ...
                    <table className=" table table-responsive table-hover">
                        ...
                        <tbody>
                            {newPatientList.map((ob, index) => <tr className="text-center"><td>{index + 1}</td>
                                ...
                                <td><button className="btn btn-sm btn-primary" onClick={() => update(ob.id)}>Update</button> &nbsp;<button className="btn btn-sm btn-danger" onClick={() => dele(ob.id)}>Delete</button></td>
                            </tr>)}
                        </tbody>
                    </table>
                </div>
